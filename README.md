...
[![Version](https://img.shields.io/badge/version-4.4.3-blue.svg)](https://github.com/rafaelghif/antigravity-agents/releases/tag/v4.4.3)
...
```bash
curl -fsSL https://raw.githubusercontent.com/rafaelghif/antigravity-agents/v4.4.3/install.sh | bash
...
```powershell
Set-ExecutionPolicy Bypass -Scope Process -Force; iwr -useb https://raw.githubusercontent.com/rafaelghif/antigravity-agents/v4.4.3/install.ps1 | iex
```
