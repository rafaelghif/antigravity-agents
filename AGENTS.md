...
- **ALWAYS** load, read, and strictly adhere to the agent core persona, tone guidelines, and philosophies defined in the agent soul profile [.agents/soul.md](file:///home/rafaelghifari/Muraghi/Project/antigravity-agent/.agents/soul.md) in every response and action to guarantee consistent enterprise-grade engineering identity across all platforms and accounts.
