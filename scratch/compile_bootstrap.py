...
def compile_bootstrap():
    ...
    templates = [
        ...
        (".agents/skills/adr-wizard/SKILL.md", ".agents/skills/adr-wizard/SKILL.md"),
        (".agents/skills/adr-wizard/scripts/main.py", ".agents/skills/adr-wizard/scripts/main.py"),
        (".agents/skills/docs-sync/SKILL.md", ".agents/skills/docs-sync/SKILL.md"),
        (".agents/skills/docs-sync/scripts/main.py", ".agents/skills/docs-sync/scripts/main.py"),
        (".agents/skills/pr-scaffolder/SKILL.md", ".agents/skills/pr-scaffolder/SKILL.md"),
        (".agents/skills/pr-scaffolder/scripts/main.py", ".agents/skills/pr-scaffolder/scripts/main.py"),
