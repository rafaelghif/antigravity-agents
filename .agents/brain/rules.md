...
- **[LEAST_PRIVILEGE_EXECUTION]**: Subagents operate under explicit tool permissions and bounded workspaces. Tool approval policies and sandbox gates are strictly respected.
