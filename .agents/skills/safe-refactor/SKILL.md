...
name: safe-refactor
description: >-
  Restructure code while preserving behavior. Use when handling extraction,
  consolidation, ownership moves, or cleanup where verification must bracket structural edits.
---
