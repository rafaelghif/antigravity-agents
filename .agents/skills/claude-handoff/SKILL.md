...
name: claude-handoff
description: >-
  Hands off the current conversation to a background subagent (via invoke_subagent or CLI background worker).
  Use when the user asks to spin off a background agent or delegate the session.
---
