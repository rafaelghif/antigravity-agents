...
description: >
  ...
  technical accuracy. Levels: lite, full, ultra and the wenyan variants. Use when
  the user asks for /caveman, "caveman mode", "talk like caveman", "be brief", or fewer tokens.
---
