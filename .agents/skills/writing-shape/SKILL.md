...
name: writing-shape
description: >-
  Shapes raw material or unstructured notes into a structured article, paragraph by paragraph.
  Use when the user asks to shape an article, turn raw notes into a drafted post, or polish written pieces.
---
