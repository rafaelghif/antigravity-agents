...
description: >-
  Turns decisions, missing requirements, or unresolved questions into a structured questionnaire for stakeholders or teammates to fill in.
  Use when the user needs to gather input from external stakeholders, managers, or clients.
---
