...
name: loop-me
description: >-
  Grills the user about specifications for workflows and recurring loops to build within the workspace.
  Use when the user wants to specify workflows, recurring task loops, or automation routines.
---
