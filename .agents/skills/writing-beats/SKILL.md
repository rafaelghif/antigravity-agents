...
name: writing-beats
description: >-
  Assembles raw research or notes into a structured narrative journey of beats, ensuring each concept is properly grounded.
  Use when the user asks to write an article, organize technical notes into a cohesive guide, or structure written content.
---
