...
description: >-
  Conducts an interview session to stress-test a plan while simultaneously documenting
  architectural decision records (ADRs) and maintaining the project domain glossary.
  Use when planning architectural changes, features requiring ADRs, or clarifying domain terms.
---
