...
## Todo
- [ ] Improve skill scaffolding CLI remote sync offline registry and verification testing (feat/issue-349) <!-- id: issue-349 -->
...
- [x] fix: exclude agent changelog/memory from target installations and isolate agent scripts in antigravityignore (feat/issue-341) <!-- id: 341 -->
...
- [x] feat: enable local github mcp by default and document local gitea host (feat/335) <!-- id: 335 -->
- [x] docs: reference official antigravity mcp docs in skill playbooks (feat/334) <!-- id: 334 -->
