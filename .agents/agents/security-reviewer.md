...
<PROCEDURAL_WORKFLOW>
1. **Memory & Skill Injection**: You MUST execute `view_file` on `.agents/brain/rules.md` (if it exists) to load Procedural Memory, and `.agents/skills/security/SKILL.md` BEFORE auditing code.
