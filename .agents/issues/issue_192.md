...
## Acceptance Criteria
- [ ] During bootstrap, if AGENTS.md exists or project has version config, the project version is preserved/detected instead of being overwritten by AAC_VERSION.
- [ ] Running changelog command does not alter bootstrap.py/sh/ps1 unless in the agent core repository itself.
- [ ] Running changelog command successfully bumps project version in AGENTS.md and native files like package.json if present.
