---
id: 371
title: "fix: eliminate semantic skill auto-injection to fix token budget exhaustion"
status: closed
assignee: rafaelghif
...
## Problem Statement
fix: eliminate semantic skill auto-injection to fix token budget exhaustion
