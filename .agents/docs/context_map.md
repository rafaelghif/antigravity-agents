...
| `.agents/skills/fullstack-development/SKILL.md` | Framework-agnostic principles for building scalable web applications, focusing on clean API boundaries, reusable components, and efficient state management. | On match |
