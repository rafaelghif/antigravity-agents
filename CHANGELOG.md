...
- **Multi-Platform Zero-Pollution Installers**:
  - Universal NPX CLI ([`bin/cli.mjs`](file:///D:/Project/antigravity-agents/bin/cli.mjs)): `npx @rafaelghif/aac init` (or `npx github:rafaelghif/antigravity-agents-core init`).
