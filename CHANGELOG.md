...
### 🐛 Bug Fixes
- **hooks:** allow GitHub auto-close syntax in commit validation hooks
...
### 🐛 Bug Fixes
- resolve bootstrap version mismatch
...
### ⚙️ Chores
- auto-generate changelog for security patch
...
### 🐛 Bug Fixes
- remove standalone binary installer fallbacks
...
### 🐛 Bug Fixes
- restore AGENTS.md template placeholders and remove core rule leak
...
### 🛠️ Refactors
- introduce StructuredLogger and ShellExecutor utilities to harden core services
...
### 🚀 Features
- prioritize GitHub/Gitea MCP tools over local for issues pull merger projects
...
### 🐛 Bug Fixes
- restore dynamic placeholders in schema template to fix bootstrap test
...
### 🚀 Features
- remove github copilot mcp reference and config
...
### 🧪 Tests
- fix path compatibility bugs on Windows in unit tests
...
### 🚀 Features
- map mcp_config template and implement validation parity check
- Map mcp_config in template_map.md and enforce programmatical template parity checks (ISSUE-285)
...
### 🚀 Features
- chore: audit MCP configurations and test active server tools (ISSUE-282)
...
### 🐛 Bug Fixes
- pin package versions in Dockerfile to prevent supply chain risks
- pin dependencies in Dockerfile to prevent supply chain vulnerabilities (ISSUE-264)
...
### 🐛 Bug Fixes
- wrap os.listdir in try-except to prevent GHA test crashes
- fix unit test failures in CI due to missing archive issues folder (ISSUE-262)
...
### 📝 Documentation
- update comprehensive audit report to V3.1

### ⚙️ Chores
- deduplicate rules.md.template section 4 guidelines
...
### 🐛 Bug Fixes
- prevent PowerShell NativeCommandError on Windows and support local dev mode

### 📝 Documentation
- Fix Windows installations failing (ISSUE-231)
...
### 🚀 Features
- add beta notices for token budget features in README.md
- Add beta notice for token tracking features in README (ISSUE-180)
...
- sync session learnings and rule registrations
...
### 🚀 Features
- Fully benchmark agent core and generate report (ISSUE-145)
...
### ⚙️ Chores
- Stage archived issue 140 and 141 specs (ISSUE-142)
